...
const founders = [
  {
    ...
    tag: "@akshat",
    line: "Turns messy briefs into shippable interfaces — obsessed with frontend craft, backend structure and the last 1%.",
  ...
  },
  {
    ...
    tag: "@sneha",
    line: "Draws the vibe, holds the taste — every pixel, interface detail and motion curve gets her signature.",
    stack: ["Design", "Frontend", "Motion"],
