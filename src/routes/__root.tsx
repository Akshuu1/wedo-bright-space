...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "WeDo — Design. Develop. Automate." },
      { name: "description", content: "WeDo is a digital studio building cinematic websites, mobile apps, and intelligent automations that help teams ship faster." },
      { name: "theme-color", content: "#0A0A0A" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "WeDo Studio" },
      { property: "og:title", content: "WeDo — Design. Develop. Automate." },
      { property: "og:description", content: "WeDo is a digital studio building cinematic websites, mobile apps, and intelligent automations that help teams ship faster." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "WeDo — Design. Develop. Automate." },
      { name: "twitter:description", content: "WeDo is a digital studio building cinematic websites, mobile apps, and intelligent automations that help teams ship faster." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            { "@type": "Organization", name: "WeDo Studio", description: "Digital studio building websites, mobile apps and intelligent automations.", url: "/" },
            { "@type": "WebSite", name: "WeDo Studio", url: "/" },
          ],
        }),
      },
    ],
