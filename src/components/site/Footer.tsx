    ...
    <footer className="mt-32 border-t border-bone/10 px-6 pb-10 pt-16 md:px-10">
      <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-12">
        ...
        <div className="md:col-span-3">
          ...
          <ul className="mt-4 space-y-2 text-bone/90">
            <li><a href="mailto:hello@wedo.studio" className="hover:text-ember">hello@wedo.studio</a></li>
            <li><a href="tel:+10000000000" className="hover:text-ember">+1 000 000 0000</a></li>
